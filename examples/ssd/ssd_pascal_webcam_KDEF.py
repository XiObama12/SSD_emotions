...
save_dir = "models/VGGNet/VOCKDEF/{}_webcam".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/VOCKDEF/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/VOCKDEF/{}_webcam".format(job_name)
